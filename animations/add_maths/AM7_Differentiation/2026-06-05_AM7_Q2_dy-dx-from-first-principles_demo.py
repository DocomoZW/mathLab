...
class Am7Q2Demo(Scene):
    def construct(self):
        # Title
        title = Text("Demo: dy/dx from First Principles", font_size=32, color=TEAL)
        ...
        formula_text = Text("AM7_Differentiation - AM7_Q2", font_size=20, color=WHITE)
