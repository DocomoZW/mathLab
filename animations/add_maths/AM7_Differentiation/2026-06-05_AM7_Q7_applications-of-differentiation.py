...
class Am7Q7Scene(Scene):
    def construct(self):
        # Title
        title = Text("Applications of Differentiation", font_size=36, color=BLUE)
        subtitle = Text("AM7_Q7 | Differentiation", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Applications of Differentiation: AM7_Q7", font_size=28, color=WHITE)
