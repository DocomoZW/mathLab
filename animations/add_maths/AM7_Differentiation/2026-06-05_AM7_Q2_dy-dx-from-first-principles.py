...
class Am7Q2Scene(Scene):
    def construct(self):
        # Title
        title = Text("dy/dx from First Principles", font_size=36, color=BLUE)
        subtitle = Text("AM7_Q2 | Differentiation", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("dy/dx from First Principles: AM7_Q2", font_size=28, color=WHITE)
