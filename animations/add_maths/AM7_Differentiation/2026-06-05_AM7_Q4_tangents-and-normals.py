...
class Am7Q4Scene(Scene):
    def construct(self):
        # Title
        title = Text("Tangents and Normals", font_size=36, color=BLUE)
        subtitle = Text("AM7_Q4 | Differentiation", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Tangents and Normals: AM7_Q4", font_size=28, color=WHITE)
