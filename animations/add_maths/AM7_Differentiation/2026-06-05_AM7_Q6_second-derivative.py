...
class Am7Q6Scene(Scene):
    def construct(self):
        # Title
        title = Text("Second Derivative", font_size=36, color=BLUE)
        subtitle = Text("AM7_Q6 | Differentiation", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Second Derivative: AM7_Q6", font_size=28, color=WHITE)
