...
class Am7Q1Scene(Scene):
    def construct(self):
        # Title
        title = Text("Limits and Gradient of Curve", font_size=36, color=BLUE)
        subtitle = Text("AM7_Q1 | Differentiation", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Limits and Gradient of Curve: AM7_Q1", font_size=28, color=WHITE)
