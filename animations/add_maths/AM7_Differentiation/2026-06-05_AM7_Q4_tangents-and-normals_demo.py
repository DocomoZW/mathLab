...
class Am7Q4Demo(Scene):
    def construct(self):
        # Title
        title = Text("Demo: Tangents and Normals", font_size=32, color=TEAL)
        ...
        formula_text = Text("AM7_Differentiation - AM7_Q4", font_size=20, color=WHITE)
