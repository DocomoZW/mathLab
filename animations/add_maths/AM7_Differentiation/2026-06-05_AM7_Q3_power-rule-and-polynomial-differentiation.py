...
class Am7Q3Scene(Scene):
    def construct(self):
        # Title
        title = Text("Power Rule and Polynomial Differentiation", font_size=36, color=BLUE)
        subtitle = Text("AM7_Q3 | Differentiation", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Power Rule and Polynomial Differentiation: AM7_Q3", font_size=28, color=WHITE)
