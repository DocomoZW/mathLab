...
class Am7Q1Demo(Scene):
    def construct(self):
        # Title
        title = Text("Demo: Limits and Gradient of Curve", font_size=32, color=TEAL)
        ...
        formula_text = Text("AM7_Differentiation - AM7_Q1", font_size=20, color=WHITE)
