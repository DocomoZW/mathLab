...
class Am7Q3Demo(Scene):
    def construct(self):
        # Title
        title = Text("Demo: Power Rule and Polynomial Differentiation", font_size=32, color=TEAL)
        ...
        formula_text = Text("AM7_Differentiation - AM7_Q3", font_size=20, color=WHITE)
