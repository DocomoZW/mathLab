...
class Am7Q7Demo(Scene):
    def construct(self):
        # Title
        title = Text("Demo: Applications of Differentiation", font_size=32, color=TEAL)
        ...
        formula_text = Text("AM7_Differentiation - AM7_Q7", font_size=20, color=WHITE)
