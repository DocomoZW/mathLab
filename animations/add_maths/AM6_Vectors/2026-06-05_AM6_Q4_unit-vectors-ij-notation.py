...
class Am6Q4Scene(Scene):
    def construct(self):
        # Title
        title = Text("Unit Vectors (i,j Notation)", font_size=36, color=BLUE)
        subtitle = Text("AM6_Q4 | Vectors in 2D", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Unit Vectors (i,j Notation): AM6_Q4", font_size=28, color=WHITE)
        ...
        summary = Text("AM6_Vectors - Concept Visualised", font_size=20, color=WHITE)
