...
class Am6Q5Scene(Scene):
    def construct(self):
        # Title
        title = Text("Scalar (Dot) Product", font_size=36, color=BLUE)
        subtitle = Text("AM6_Q5 | Vectors in 2D", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Scalar (Dot) Product: AM6_Q5", font_size=28, color=WHITE)
