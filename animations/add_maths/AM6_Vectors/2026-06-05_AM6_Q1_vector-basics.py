...
class Am6Q1Scene(Scene):
    def construct(self):
        # Title
        title = Text("Vector Basics", font_size=36, color=BLUE)
        subtitle = Text("AM6_Q1 | Vectors in 2D", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Vector Basics: AM6_Q1", font_size=28, color=WHITE)
