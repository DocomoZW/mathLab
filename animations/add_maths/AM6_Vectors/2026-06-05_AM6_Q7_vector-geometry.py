...
class Am6Q7Scene(Scene):
    def construct(self):
        # Title
        title = Text("Vector Geometry", font_size=36, color=BLUE)
        subtitle = Text("AM6_Q7 | Vectors in 2D", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Vector Geometry: AM6_Q7", font_size=28, color=WHITE)
