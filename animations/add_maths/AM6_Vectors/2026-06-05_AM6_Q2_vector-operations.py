...
class Am6Q2Scene(Scene):
    def construct(self):
        # Title
        title = Text("Vector Operations", font_size=36, color=BLUE)
        subtitle = Text("AM6_Q2 | Vectors in 2D", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Vector Operations: AM6_Q2", font_size=28, color=WHITE)
