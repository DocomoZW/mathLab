...
class Am6Q3Scene(Scene):
    def construct(self):
        # Title
        title = Text("Position Vectors", font_size=36, color=BLUE)
        subtitle = Text("AM6_Q3 | Vectors in 2D", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Position Vectors: AM6_Q3", font_size=28, color=WHITE)
