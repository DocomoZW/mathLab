...
class Am6Q6Scene(Scene):
    def construct(self):
        # Title
        title = Text("Angle Between Vectors", font_size=36, color=BLUE)
        subtitle = Text("AM6_Q6 | Vectors in 2D", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Angle Between Vectors: AM6_Q6", font_size=28, color=WHITE)
