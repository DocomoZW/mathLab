...
class Am8Q4Scene(Scene):
    def construct(self):
        # Title
        title = Text("Area Between Curves", font_size=36, color=BLUE)
        subtitle = Text("AM8_Q4 | Integration and Kinematics", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Area Between Curves: AM8_Q4", font_size=28, color=WHITE)
