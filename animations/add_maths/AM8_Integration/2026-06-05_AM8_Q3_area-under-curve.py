...
class Am8Q3Scene(Scene):
    def construct(self):
        # Title
        title = Text("Area Under Curve", font_size=36, color=BLUE)
        subtitle = Text("AM8_Q3 | Integration and Kinematics", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Area Under Curve: AM8_Q3", font_size=28, color=WHITE)
