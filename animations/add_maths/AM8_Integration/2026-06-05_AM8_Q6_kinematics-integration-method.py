...
class Am8Q6Scene(Scene):
    def construct(self):
        # Title
        title = Text("Kinematics (Integration Method)", font_size=36, color=BLUE)
        subtitle = Text("AM8_Q6 | Integration and Kinematics", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Kinematics (Integration Method): AM8_Q6", font_size=28, color=WHITE)
