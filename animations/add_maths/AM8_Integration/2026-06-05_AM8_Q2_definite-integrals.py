...
class Am8Q2Scene(Scene):
    def construct(self):
        # Title
        title = Text("Definite Integrals", font_size=36, color=BLUE)
        subtitle = Text("AM8_Q2 | Integration and Kinematics", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Definite Integrals: AM8_Q2", font_size=28, color=WHITE)
