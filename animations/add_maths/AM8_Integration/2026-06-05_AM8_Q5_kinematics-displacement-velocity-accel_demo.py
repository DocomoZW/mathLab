...
class Am8Q5Demo(Scene):
    def construct(self):
        # Title
        title = Text("Demo: Kinematics (Displacement Velocity Accel)", font_size=32, color=TEAL)
        ...
        formula_text = Text("AM8_Integration - AM8_Q5", font_size=20, color=WHITE)
