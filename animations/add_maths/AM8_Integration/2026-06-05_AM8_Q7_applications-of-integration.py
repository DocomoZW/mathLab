...
class Am8Q7Scene(Scene):
    def construct(self):
        # Title
        title = Text("Applications of Integration", font_size=36, color=BLUE)
        subtitle = Text("AM8_Q7 | Integration and Kinematics", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Applications of Integration: AM8_Q7", font_size=28, color=WHITE)
