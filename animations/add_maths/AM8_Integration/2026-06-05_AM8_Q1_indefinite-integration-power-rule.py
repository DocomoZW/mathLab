...
class Am8Q1Scene(Scene):
    def construct(self):
        # Title
        title = Text("Indefinite Integration (Power Rule)", font_size=36, color=BLUE)
        subtitle = Text("AM8_Q1 | Integration and Kinematics", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Indefinite Integration (Power Rule): AM8_Q1", font_size=28, color=WHITE)
