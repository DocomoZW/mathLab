...
class Am8Q6Demo(Scene):
    def construct(self):
        # Title
        title = Text("Demo: Kinematics (Integration Method)", font_size=32, color=TEAL)
        ...
        formula_text = Text("AM8_Integration - AM8_Q6", font_size=20, color=WHITE)
