...
class Am8Q7Demo(Scene):
    def construct(self):
        # Title
        title = Text("Demo: Applications of Integration", font_size=32, color=TEAL)
        ...
        formula_text = Text("AM8_Integration - AM8_Q7", font_size=20, color=WHITE)
