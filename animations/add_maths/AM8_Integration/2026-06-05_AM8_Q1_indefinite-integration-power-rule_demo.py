...
class Am8Q1Demo(Scene):
    def construct(self):
        # Title
        title = Text("Demo: Indefinite Integration (Power Rule)", font_size=32, color=TEAL)
        ...
        formula_text = Text("AM8_Integration - AM8_Q1", font_size=20, color=WHITE)
