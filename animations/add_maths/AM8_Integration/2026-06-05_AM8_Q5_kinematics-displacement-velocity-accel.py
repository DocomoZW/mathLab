...
class Am8Q5Scene(Scene):
    def construct(self):
        # Title
        title = Text("Kinematics (Displacement, Velocity, Accel)", font_size=36, color=BLUE)
        subtitle = Text("AM8_Q5 | Integration and Kinematics", font_size=20, color=GRAY)
        ...
        # Show concept text
        concept = Text("Kinematics (Displacement, Velocity, Accel): AM8_Q5", font_size=28, color=WHITE)
        ...
        summary = Text("AM8_Integration - Concept Visualised", font_size=20, color=WHITE)
