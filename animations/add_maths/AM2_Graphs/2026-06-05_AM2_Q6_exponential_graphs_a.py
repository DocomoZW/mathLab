...
class ExpGrowth(Scene):
    def construct(self):
        title = Text("Exponential Growth: y = e^x", font_size=34)
        title.to_edge(UP)
        ...
        # Mark (0,1) - graph origin at (LEFT*4, DOWN*0.5), point (0,1) at (LEFT*4, 0)
        ...
        asymp_label.next_to(asymp, LEFT, buff=0.2)
